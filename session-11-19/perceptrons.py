...
decision = "Should I have a salad for dinner?"

# Pick three factors that affect your decision and write them as strings
factor_1 = "Did I eat something healthy the other night?"
factor_2 = "Am I going to work out to night?"
factor_3 = "Am I going to sleep early tonight?"
...
# etc:
weights = np.array([1,1,1]) #your code here
...
factor_values = np.array([1,1,1])# your code here
