...
longitude = grp.createVariable('longitude', 'f4', 'lon') #creates variables in numpy array 
latitude = grp.createVariable('latitude', 'f4', 'lat')  #creates variables in numpy array, f4 means that the values will be floats
depth = grp.createVariable('depth', 'f4', 'depth')#creates variables in numpy array 
time = grp.createVariable('time','f4', 'time') #creates variables in numpy array 
w = grp.createVariable('w', 'f4', ('time', 'lat', 'lon', 'depth'))  #adds units to netcdf variables

 
longitude[:] = longitude_val  #fills the variables in the netcdf file with the values from the numpy arrays
